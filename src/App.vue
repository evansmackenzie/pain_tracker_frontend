  ...
  <div id="app">
    ...
    >
      <div class="container g-mb-60">
        <div class="row">
          <!-- Footer Content -->
          <div class="col-lg-8 col-md-6 g-mb-40 g-mb-0--lg">
            ...
            <div class="g-mb-30">
              <p>
                I am a Web Developer and Registered Nurse with a long history of
                chronic back pain and sciatica. I have tried many different
                treatments and visited various specialists with minimal relief
                of my symptoms. After years of feeling like I was stuck living
                with chronic pain, I realized that working on my mentality
                around my pain experience could lead to actual physiological
                improvements in my symptoms. Through meditation, strength
                training, and recognizing and changing behaviors that made my
                symptoms worse, I was finally able to envision a way to live
            ...
            <ul class="list-unstyled">
              <li class="g-mb-5">
                ...
                <a
                  ...
                  href="https://journals.lww.com/spinejournal/Abstract/2002/11150/Behavioral_and_Cognitive_Behavioral_Treatment_for.33.aspx"
                  >CBT and Chronic Pain</a
                >
              </li>
              <li class="g-mb-5">
                <i class="fa fa-angle-right g-mr-5"></i>
                <a
                  class="g-color-white-opacity-0_8"
                  href="https://journals.lww.com/acsm-csmr/Fulltext/2012/07000/Resistance_Training_is_Medicine___Effects_of.13.aspx"
                  >Strength Training and Mental Health</a
                >
              </li>
              <li class="g-mb-5">
                <i class="fa fa-angle-right g-mr-5"></i>
                <a
                  class="g-color-white-opacity-0_8"
                  href="https://paindoctor.com/chronic-pain-books/"
                  >Suggested Reading</a
                >
              </li>
            </ul>
